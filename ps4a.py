...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) != 0:
        ...
        word = raw_input()
        if word == '.':
            print 'Goodbye! Total score: %s points' % totalScore
            break        
        else:
            if isValidWord(word, hand, wordList) == False:
                ...
                totalScore += score
                print '"%s" ' % word,
                print 'earned %s points. ' % score ,
                print 'Total: %s points' %totalScore
                print
                hand = updateHand(hand, word)
                               
    if calculateHandlen(hand) == 0:
        print 'Run out of letters. Total score: %s' %totalScore
